...
Color getAnimatedColor(Color previous, Color target, double animationPercent) {
  var r =
      (((target.r! - previous.r!) * animationPercent) + previous.r!).round();
  var g =
      (((target.g! - previous.g!) * animationPercent) + previous.g!).round();
  var b =
      (((target.b! - previous.b!) * animationPercent) + previous.b!).round();
