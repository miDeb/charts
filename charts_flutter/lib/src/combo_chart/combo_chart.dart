...
class NumericComboChart extends CartesianChart<num> {
  NumericComboChart(
    ...
    common.AxisSpec<num>? domainAxis,
    common.AxisSpec<num>? primaryMeasureAxis,
    common.AxisSpec<num>? secondaryMeasureAxis,
  ...
  @override
  common.NumericCartesianChart createCommonChart(
      BaseChartState<num>? chartState) {
...
class OrdinalComboChart extends CartesianChart<String> {
  OrdinalComboChart(
    ...
    bool? animate,
    Duration? animationDuration,
    common.AxisSpec<String>? domainAxis,
    common.AxisSpec<num>? primaryMeasureAxis,
    common.AxisSpec<num>? secondaryMeasureAxis,
  ...
  @override
  common.OrdinalCartesianChart createCommonChart(BaseChartState<String>? chartState) {
    // Optionally create primary and secondary measure axes if the chart was
    // configured with them. If no axes were configured, then the chart will
    // use its default types (usually a numeric axis).
